export const en = {
  ...
  recommend: {
    ...
    fromSender: "Recommended by {{name}}",
  },
  likes: {
    like: "Like",
    unlike: "Unlike",
  ...
  watch: {
    ...
    inviteSentMultiple: "{{count}} invitations sent.",
    inviteError: "Couldn't send the invitation.",
    noInvitableFriendsTitle: "No one to invite",
  ...
  insights: {
    ...
    scrubHint: "Touch the chart to explore what you watched.",
    avgLabel: "Avg {{value}}",
    typicalRange: "typical {{low}}–{{high}}",
    ...
    streakLast30: "Last 30 days",
    ringsTitle: "Compared to last period",
    prevShort: "prev {{value}}",
    breakdownTitle: "Breakdown",
    mediaMix: "Movies vs series",
    genreMix: "Top genres",
    other: "Other",
