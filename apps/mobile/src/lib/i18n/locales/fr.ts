...
export const fr: typeof en = {
  ...
  recommend: {
    ...
    fromSender: "Recommandé par {{name}}",
  },
  likes: {
    like: "J'aime",
  ...
  watch: {
    ...
    inviteSentMultiple: "{{count}} invitations envoyées.",
    inviteError: "Impossible d'envoyer l'invitation.",
    noInvitableFriendsTitle: "Personne à inviter",
